...
interface EditNodeGmailForm {
  credentials: Credential[];
  workflowId: string;
  nodes: Node[];
  handleModal: (value: boolean) => void;
}
const EditNodeGmailForm = ({ credentials, workflowId, nodes, handleModal }: EditNodeGmailForm) => {
  ...
  useEffect(() => {
    const telegramNode = nodes.find((node: Node) => node.id === "gmail") as Node;
...
export default EditNodeGmailForm;
